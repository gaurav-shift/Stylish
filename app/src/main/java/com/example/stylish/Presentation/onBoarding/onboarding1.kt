...
fun Onboarding1Screen(navController: NavController) {
        Scaffold(
//            topBar = {TopIndicator(0,3, onSkipClick = {})},
//            bottomBar = { ButtomIndicator(3,0)}
        ) {
            Column(
                modifier = Modifier
                    .padding(it)
                ...
                Column(modifier = Modifier
                    ...
                    TopIndicator(0,3, onSkipClick = {navController.navigate(Routes.Login)})
                }
                ...
                )
                {
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.fashion_shop_rafiki_1), "logo1",
                        modifier = Modifier
