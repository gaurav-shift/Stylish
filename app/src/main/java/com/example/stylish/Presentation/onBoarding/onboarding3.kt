...
fun Onboarding3Screen(navController: NavController) {
    Scaffold(
//        topBar = {TopIndicator(2,3, onSkipClick = {navController.navigate("login")})},
//        bottomBar = { ButtomIndicator(3,2)}
    )
    {
        ...
        )
        {
            ...
            Column(
                ...
                TopIndicator(2, 3, onSkipClick = { navController.navigate(Routes.Login) })
            }
            ...
            )
        {
            ...
            Image(painter = painterResource(id=R.drawable.shopping_bag_rafiki),"logo3",
                modifier = Modifier
